...
Without that env var set, the page refuses to load (it lists customer
emails, so it stays locked down until you choose a key). Add `&format=json`
to the URL for raw JSON instead of the table.
